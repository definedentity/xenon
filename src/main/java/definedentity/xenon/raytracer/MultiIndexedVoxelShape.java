...
/**
 * A VoxelShape implementation, produces a {@link VoxelShapeBlockHitResult} when ray traced. Whilst similar to
 * {@link IndexedVoxelShape}, will ray trace each sub-component provided, returning the closest.
 *
 * <p>The sub-component will have its outline automatically rendered appropriately.
 *
 * <p>Created by covers1624 on 5/12/20.
 */
public class MultiIndexedVoxelShape extends VoxelShape {
    ...
    /**
     * Constructs a MultiIndexedVoxelShape, using the provided VoxelShape as this shape, whilst still RayTracing against
