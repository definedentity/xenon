...
/** Contains a bunch of stuff to do with rotation. Created by covers1624 on 6/30/2016. */
public class RotationUtils {
     ...
     *
     * @param rotation The entity rotation, Generally {@code MathHelper.floor_double((entity.rotationYaw * 4F) / 360F +
     *     0.5D) & 3};
