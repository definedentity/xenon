...
public class FormatUtil {
    ...
    public static String formatNumber(double value) {
        ...
        else if (Math.abs(value) < 1000000D)
            return addCommas((int) value); // I mean whats the point of displaying 1.235K instead of 1,235?
    ...
    public static String formatNumber(long value) {
        ...
        else if (Math.abs(value) < 1000000000000000000L)
            return Math.round((double) (value / 1000000000000L)) / 1000D + "P";
