...
import definedentity.xenon.render.lighting.PlanarLightModel;
 ...
 * Multithreaded chunk batching. TODO, proper piping of BakedQuads and CCBakedQuads.
 */
public class CCRenderState {
    ...
    /**
     * Lets the {@link LightMatrix} or {@link PlanarLightModel} know if this {@link CCRenderState} should compute
     * lighting.
     */
    ...
    /**
     * Bind this {@link CCRenderState} instance to the {@link Tesselator} buffer and prepare to start drawing vertices
     * for the given <code>mode</code> and {@link VertexFormat}.
     *
    ...
    /**
     * Bind this {@link CCRenderState} instance to the given {@link BufferBuilder} and prepare to start drawing vertices
     * for the given <code>mode</code> and {@link VertexFormat}.
     *
     * @param mode The Draw Mode.
     * @param format The {@link VertexFormat}.
    ...
    /**
     * Bind this {@link CCRenderState} to the given {@link RenderType}, applying the given MatrixStack.
     *
     * @param renderType The {@link RenderType} to bind to.
     * @param source The {@link MultiBufferSource} instance.
