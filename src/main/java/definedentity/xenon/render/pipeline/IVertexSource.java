...
public interface IVertexSource {
     ...
     *
     * <p>By default, this method just returns the length of the @link #getVertices()} array.
     *
     ...
     * @return The {@code T} for the given {@link AttributeKey} or {@code null} of the Attribute does not exist.
     */
     ...
     *
     * <p>The {@link IVertexSource} will either return data from {@link #getAttribute(AttributeKey)} or set the state in
     * {@link #prepareVertex(CCRenderState)}.
     *
