...
public class RenderUtils {
    ...
    public static void makeFluidQuadVertices(
            List<Vertex5> vertices, Vector3 base, Vector3 wide, Vector3 high, TextureAtlasSprite icon, double res) {
        ...
        while (x < wlen) {
            ...
            while (y < hlen) {
                ...
                vertices.add(new Vertex5(
                        ...
                        v2 - ry / res * dv));
                vertices.add(
                        new Vertex5(base.x + dx1.x + dy1.x, base.y + dx1.y + dy1.y, base.z + dx1.z + dy1.z, u1, v2));
                vertices.add(new Vertex5(
                        base.x + dx2.x + dy1.x,
                        base.y + dx2.y + dy1.y,
                        base.z + dx2.z + dy1.z,
    ...
    /**
     * Builds a solid cuboid. Expects VertexFormat of POSITION_COLOR. If you need anything more specialized, Use a
     * {@link CCModel}.
     *
    ...
    private static void bufferLinePair(
        ...
        builder.vertex(x1, y1, z1)
                .color(r, g, b, a)
                .normal((float) v1.x, (float) v1.y, (float) v1.z)
                .endVertex();
