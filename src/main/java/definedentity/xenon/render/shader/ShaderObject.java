...
public interface ShaderObject {
    ...
    /**
     * A simple identifier for this {@link ShaderObject}, used for logging.
     *
     * @return The name.
     */
    String getName();
    ...
    /**
     * Gets all {@link UniformPair}s this shader exposes. It is expected that a {@link ShaderObject} will not
     * dynamically change the uniforms it exposes over its lifetime. Doing so is not enforced, but will break the
     * Uniform pipeline.
     *
    ...
    /** Allocates and compiles this {@link ShaderObject}. Does nothing if the shader is already compiled. */
    void alloc();
