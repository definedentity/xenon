...
import static definedentity.xenon.math.MathHelper.phi;
...
public class CCModelLibrary {
    ...
    public static RenderType getIcos4RenderType(ResourceLocation texture) {
        return RenderType.create(
                "icosahedron4", DefaultVertexFormat.BLOCK, VertexFormat.Mode.TRIANGLES, 256, makeIcosState(texture));
    }

    public static RenderType getIcos7RenderType(ResourceLocation texture) {
        return RenderType.create(
                "icosahedron7", DefaultVertexFormat.BLOCK, VertexFormat.Mode.QUADS, 256, makeIcosState(texture));
    }
